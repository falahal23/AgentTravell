...
import { FaEye, FaTrash, FaSearch, FaMoneyBill, FaCreditCard, FaCalendarAlt, FaFilter, FaUndo, FaChevronLeft, FaChevronRight } from "react-icons/fa";
...
export default function DataTransaksi() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [search, paymentFilter, productFilter, yearFilter, amountFilter, sortBy]);
